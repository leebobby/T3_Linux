    ...
    ui(new Ui::ReverseLine)
{
    ...
    reverse_setting_label->setStyleSheet(tr("background-image: url(:/image/image/reverseline2.png);"));
    ...
    rearVision_setting_label->setStyleSheet(tr("background-image: url(:/image/image/reverseline1.png);"));
